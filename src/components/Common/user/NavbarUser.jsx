  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography
        ...
        className="text-lg p-1 font-normal text-black-600 mr-10"
      >
        <a href="/hubs" className="flex items-center group relative ml-0 mr-0 font-bold md:ml-2 md:mr-2 lg:mr-4 sm:mr-4 transition-color hover:text-red-600 transition-transform duration-300 hover:translate-x-1">
          Hubs
          <span className="absolute bottom-0 left-0 w-full h-0.5 bg-red-500 transform origin-bottom scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span>
        </a>
      </Typography>
    ...
    <navbar className="  lg:rounded-none   fixed top-0 left-0 right-0 bg-[#e5e5e5] z-50">
      <div className="relative mx-auto flex items-center container justify-between text-blue-gray-900 py-3">
        <Typography
          as="a"
          href="/"
          className="text-lg mr-4 cursor-pointer py-1.5 font-medium transition-transform duration-300 hover:translate-x-2"
          color="black"
        >
          GRAB YOUR SPACE
        </Typography>
              ...
              <Menu>
                ...
                <MenuList>
                  ...
                  >
                    ...
                    <Typography o variant="small" className="font-medium">
                      My Profile
                    </Typography>
                  </MenuItem>

                  <MenuItem
                    onClick={() => navigate("/bookedlist")}
                    className="flex items-center gap-2"
                  >
                    <svg
                      width="16"
